Shader "Shader Graphs/DepthTest"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        {
            SurfaceDescription surface = (SurfaceDescription)0;
            float _HDSceneDepth_895d1c2460244e018336d445247b1d29_Output_2_Float = Unity_HDRP_SampleSceneDepth_float(float4(IN.NDCPosition.xy, 0, 0).xy, float(0));
            surface.BaseColor = (_HDSceneDepth_895d1c2460244e018336d445247b1d29_Output_2_Float.xxx);
